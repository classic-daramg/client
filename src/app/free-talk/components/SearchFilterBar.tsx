...
아래 항목에 해당하는 게시물이나 댓글은 사전 예고 없이 삭제될 수 있으며, 이용 제재의 대상이 됩니다.

저작권 침해: 외부 공개가 금지된 공연의 영상 촬영/녹음본 업로드 및 제3자의 지적재산권 침해 금지

타인 비방 및 명예훼손: 특정 회원, 연주자, 제3자에 대한 비하, 욕설, 업무 방해 행위 금지

부적절한 콘텐츠: 외설적이거나 폭력적인 메시지, 공공질서에 반하는 게시물, 도배성 게시물, 광고성 정보 송신 행위 금지

정보 도용: 타인의 명의나 정보를 도용하여 게시물을 작성하는 행위 금지

위반 시 조치 안내

운영팀은 모니터링 및 회원 신고를 통해 부정행위를 적발하며, 아래 기준에 따라 제재를 부과합니다.

• 1회 적발 시: 게시물 및 댓글 작성 7일 제한
• 2회 적발 시: 게시물 및 댓글 작성 14일 제한
• 3회 적발 시: 소명 기회 부여 및 최종 회원탈퇴 처분

3회 적발 시 가입 이메일로 제재 사실을 통지합니다. 통지 후 30일간 소명 기회를 드립니다. 기한 내 소명이 없거나 부적절한 경우 회원 자격이 상실(강제 탈퇴)될 수 있습니다.

서비스 질서 유지 및 부정이용 방지를 위해, 탈퇴 후 31일간 동일한 이메일로 재가입이 불가능합니다. 탈퇴 후 31일간 재가입 제한 확인을 위해 이메일 주소 및 징계 기록이 안전하게 보존된 후 파기됩니다.
