...
export default function InfoBanner() {
    return (
        <div className="w-full px-5 py-7 bg-white flex flex-col items-center gap-3.5 mb-2.5">
            <div className="flex flex-col items-center justify-center gap-4 text-center">
                ...
                <div className="text-zinc-400 text-xs font-medium font-['Pretendard'] leading-tight whitespace-pre-line">
