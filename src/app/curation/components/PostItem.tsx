  ...
  return (
    <>
      ...
      >
        ...
        {post.imageUrl && (
          <div
            className="relative w-[100px] h-[100px] bg-[#d9d9d9] rounded-[8px] ml-4 flex items-center justify-center overflow-hidden cursor-pointer hover:opacity-80 transition-opacity"
